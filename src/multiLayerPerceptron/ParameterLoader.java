				...
				for(int j=0;j<NALGS;j++){
					...
					for(int k=0;k<paramNames[j].length;k++){
						...
						switch(j){
							case 0:
								switch(k){
									case 0: br.write("1000");break;
									case 1: br.write("0.005");break;
									case 2: br.write("0.2");break;
								}break;
							case 1:
								br.write("0.0");
								break;
							case 2://diffev
								switch(k){
									case 0: br.write("500");break;
									case 1: br.write("10");break;
									case 2: br.write("0.8");break;
									case 3: br.write("0.6");break;
								}break;
							case 3:
								br.write("0.0");
								break;
