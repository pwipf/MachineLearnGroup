...
public class BackProp{
	...
	public static void main(String[] args) {
		...
		double rho =.2;
                ...
                double mutationPercentChange = .15;
                double mutationChance = .00015;
		...
		for(int fold=0;fold<10;fold++){
			...
			//net.trainDiffEv(trainx, trainy, maxEpochs, npop, beta, rho);
                        net.trainGeneticAlg(trainx, trainy, maxEpochs2, npop2, crossoverRate, mutationPercentChange, mutationChance);
			/////////////////////////////////////////////////////////////
